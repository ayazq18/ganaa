...
const AdmissionChecklist = () => {
    ...
    if (patientData.patientAdmission._id) {
      ...
      setadmissionChecklistLink((prev) => ({
        ...
        inVoluntaryAdmissionFormLink:
          ...
          admissiondocumentsLink: patientData.patientAdmission.admissiondocumentsLink || [],
      ...
      setIsAdmissionChecklist((prevState) => ({
        ...
        isadmissiondocuments:patientData.patientAdmission.isadmissiondocuments || false,
  ...
  const handleSubmit = async (
    ...
    try {
     ...
     setadmissionChecklistLink((prev) => ({
  ...prev,
  voluntaryAdmissionFormLink: admissionReponse?.data?.data?.admissionChecklist?.voluntaryAdmissionForm,
  applicationForAdmissionLink: admissionReponse?.data?.data?.admissionChecklist?.applicationForAdmission,
  inVoluntaryAdmissionFormLink: admissionReponse?.data?.data?.admissionChecklist?.inVoluntaryAdmissionForm,
  admissiondocumentsLink: admissionReponse?.data?.data?.admissionChecklist?.admissiondocuments, 
  minorAdmissionFormLink: admissionReponse?.data?.data?.admissionChecklist?.minorAdmissionForm,
  familyDeclarationLink: admissionReponse?.data?.data?.admissionChecklist?.familyDeclaration,
  section94Link: admissionReponse?.data?.data?.admissionChecklist?.section94,
  capacityAssessmentLink: admissionReponse?.data?.data?.admissionChecklist?.capacityAssessment,
  hospitalGuidelineFormLink: admissionReponse?.data?.data?.admissionChecklist?.hospitalGuidelineForm,
  finacialCounsellingLink: admissionReponse?.data?.data?.admissionChecklist?.finacialCounselling,
  insuredFileLink: admissionReponse?.data?.data?.admissionChecklist?.insuredFile
}));

setIsAdmissionChecklist({
  isapplicationForAdmission: admissionReponse?.data?.data?.admissionChecklist?.applicationForAdmission?.length ? true : false,
  isvoluntaryAdmissionForm: admissionReponse?.data?.data?.admissionChecklist?.voluntaryAdmissionForm?.length ? true : false,
  isinVoluntaryAdmissionForm: admissionReponse?.data?.data?.admissionChecklist?.inVoluntaryAdmissionForm?.length ? true : false,
  isadmissiondocuments: admissionReponse?.data?.data?.admissionChecklist?.admissiondocuments?.length ? true : false, // ✅ NEW
  isminorAdmissionForm: admissionReponse?.data?.data?.admissionChecklist?.minorAdmissionForm?.length ? true : false,
  isfamilyDeclaration: admissionReponse?.data?.data?.admissionChecklist?.familyDeclaration?.length ? true : false,
  issection94: admissionReponse?.data?.data?.admissionChecklist?.section94?.length ? true : false,
  iscapacityAssessment: admissionReponse?.data?.data?.admissionChecklist?.capacityAssessment?.length ? true : false,
  ishospitalGuidelineForm: admissionReponse?.data?.data?.admissionChecklist?.hospitalGuidelineForm?.length ? true : false,
  isfinacialCounselling: admissionReponse?.data?.data?.admissionChecklist?.finacialCounselling?.length ? true : false
});
          ...
          dispatch(
            setPatientAdmission({
              ...
              isvoluntaryAdmissionForm: admissionReponse?.data?.data?.admissionChecklist
                ...
                ? true
                : false,
                   isadmissiondocuments: admissionReponse?.data?.data?.admissionChecklist
      ?.admissiondocuments?.length
      ? true
      : false, // ✅ NEW
              ...
              applicationForAdmissionLink:
                admissionReponse?.data?.data?.admissionChecklist?.applicationForAdmission,
                 admissiondocumentsLink: admissionReponse?.data?.data?.admissionChecklist?.admissiondocuments, // ✅ NEW
              inVoluntaryAdmissionFormLink:
        ...
        if (delteData) {
          ...
          setIsAdmissionChecklist({
            ...
            iscapacityAssessment: delteData?.data?.data?.admissionChecklist?.capacityAssessment
              ...
              ? true
              : false,
                isadmissiondocuments: delteData?.data?.data?.admissionChecklist
    ?.admissiondocuments?.length
    ? true
    : false,
          ...
          dispatch(
            setPatientAdmission({
              ...
              orientationOfPatient: delteData?.data?.data?.admissionChecklist?.orientationOfPatient
                ...
                ? true
                : false,
                    isadmissiondocuments: delteData?.data?.data?.admissionChecklist?.admissiondocuments?.length
      ? true
      : false,
              isapplicationForAdmission: delteData?.data?.data?.admissionChecklist
                ?.applicationForAdmission?.length
