              ...
              <table className="w-full border-collapse">
                <thead className="sticky top-0 z-30">
                  <tr className="bg-[#CCB69E] border-b border-[#c7bfa7]">
                    ...
                    {/* {data?.therapists.map((psy) => (
                      ...
                      >
                        <div className="w-44 mx-auto">
                          ...
                          <div className=" text-center text-nowrap text-[#505050] ">
                            {psy.centerId?.centerName}
                          </div>
                        </div>
                      </th>
                    ))} */}
                    {/* <th
                      ...
                      className="sticky left-[498px] px-2 bg-[#A2876A] z-10"
                    >
                ...
                <tbody>
                  ...
                  {(state.sort
                    ...
                    const notesByTherapist = data?.notes
