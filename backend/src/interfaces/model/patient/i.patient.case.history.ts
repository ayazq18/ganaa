...
export interface IInsight {
  insightGrade?: '1' | '2' | '3' | '4' | '5' | '6';
  insight: string;
}

export interface ISubstanceUseHistory {
...
export interface IHistoryOfPresentIllness {
  onset?: 'Abrupt' | 'Acute' | 'Subacute' | 'Insidious' | 'Other' | '';
  course?: 'Continuous' | 'Episodic' | 'Fluctuating' | 'Other' | '';
...
export interface IPatientCaseHistory extends mongoose.Document {
